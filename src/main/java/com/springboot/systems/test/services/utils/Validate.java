...
public abstract class Validate {
	 ...
	 * @throws ValidationFailedException, if the email address is invalid
	 */
	public static void emailValidator(String emailAddress) throws ValidationFailedException {
